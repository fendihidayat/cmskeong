                        ...
                        <div class="weekly2-news-active dot-style d-flex dot-style">
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="<?php echo base_url(); ?>assets/front_end/img/news/weekly2News1.jpg" alt="">
                                </div>
                            ...
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="<?php echo base_url(); ?>assets/front_end/img/news/weekly2News2.jpg" alt="">
                                </div>
                                <div class="weekly2-caption">
                            ...
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="<?php echo base_url(); ?>assets/front_end/img/news/weekly2News3.jpg" alt="">
                                </div>
                                <div class="weekly2-caption">
                                    <span class="color1">Corporate</span>
                                    <p>25 Jan 2020</p>
                             ...
                             <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="<?php echo base_url(); ?>assets/front_end/img/news/weekly2News4.jpg" alt="">
                                </div>
                                <div class="weekly2-caption">
                    ...
                    <div class="col-12">
                        <div class="recent-active dot-style d-flex dot-style">
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="<?php echo base_url(); ?>assets/front_end/img/news/recent1.jpg" alt="">
                                </div>
                                <div class="what-cap">
                            ...
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="<?php echo base_url(); ?>assets/front_end/img/news/recent2.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                            ...
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="<?php echo base_url(); ?>assets/front_end/img/news/recent3.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
...
<?php
    $this->load->view('client_layout/11_footer');