            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <form role="form" action="<?php echo base_url(). 'kategori/update'; ?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                        <?php foreach($kategori as $isidata){ ?>
                            <div class="form-group">
                                <label>Nama Kategori</label>
                                <input type="hidden" value="<?php echo $isidata->id_kategori; ?>" name="id_kategori" class="form-control" id="exampleInputEmail1" placeholder="Username">                            
                                <input type="hidden" value="<?php echo $isidata->nama_kategori; ?>"  name="nama_kategori_asli" class="form-control" id="exampleInputEmail1" placeholder="Nama Kategori Berita" required>
                                <input type="text" value="<?php echo $isidata->nama_kategori; ?>"  name="nama_kategori" class="form-control" id="exampleInputEmail1" placeholder="Nama Kategori Berita" required>
                            </div>
                        <?php } ?>
                        </div>
                        <!-- /.card-body -->
