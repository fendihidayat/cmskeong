                    ...
                    <div class="card-body"> 
                        ...
                        <div class="form-group">
                            ...
                            <label>Deskripsi Gambar</label>
                                <textarea name="deskripsi_gambar" class="note" 
                                        style="width: 100%; height: 100%; font-size: 10px; line-height: 12px; border: 1px solid #dddddd; padding: 5px;" required>
                            ...
                            <label>Tag/Label</label>
                                <textarea name="tag_label" class="note" 
                                        style="width: 100%; height: 100%; font-size: 10px; line-height: 12px; border: 1px solid #dddddd; padding: 5px;" required>
                                    <?php echo $tag_label; ?>
                                </textarea>
