                ...
                <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                <input type="hidden" value="<?php echo $id_berita; ?>" name="id_berita" class="form-control">
                                <input type="hidden" value="<?php echo $judul_asli; ?>" name="judul_asli" class="form-control">
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Gambar</label>
                                <input type="hidden" value="<?php echo $gambar_asli; ?>" name="gambar_asli" class="form-control">
                                <img src="<?php echo base_url(); ?>gambar/berita/<?php echo $gambar_asli; ?>" width='100%' height='100%' align='center'>
                            ...
                            <label>Deskripsi Gambar</label>
                                <textarea name="deskripsi_gambar" class="form-control" id="exampleFormControlTextarea1" rows="3" required><?php echo trim($deskripsi_gambar); ?></textarea>
                            
                            </div>
                            <!-- /.card-header -->
                            <div class="mb-3">                            
                            <label>Tag/Label</label>
                                <textarea name="tag_label" class="form-control" id="exampleFormControlTextarea1" rows="3" required><?php echo trim($tag_label); ?></textarea>
